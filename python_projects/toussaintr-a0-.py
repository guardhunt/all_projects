...
myinput = raw_input('What is your favorite color?')
...
if myinput == 'Blue' or 'blue': # else if
...
elif myinput == 'red' or myname == 'Red' or myname == 'Green' or myname=='green':
...
saying6='Roland Junior favorite color is blue'
