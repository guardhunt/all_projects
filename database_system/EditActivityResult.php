...
<CENTER>
	<h1>Home Directory</h1>
      <div class="jumbotron">
		...
		if(($_POST['a_title'] == NULL) and ($_POST['a_date'] == NULL) and ($_POST['a_time'] == NULL)
			and ($_POST['a_desc'] == "")and ($_POST['a_narr'] == "")and (!isset($_POST['a_loc']))
			and (!isset($_POST['a_type'])) and (!isset($_POST['a_goal']))){
